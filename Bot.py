        ...
        for x in range(1,6):   
            ...
            if randint(1,10) > 1:
                ...
                if number_of_likes < 1000:
                    comment_area.send_keys(Commenting_adjectives[randint(0, len(Commenting_adjectives) - 1)] ,' Pic!  Follow back for ', Commenting_adjectives[randint(0, len(Commenting_adjectives) - 1)], "patriotic content. How's the josh:)")
                    sleep(3)

                else:
                    comment_area.send_keys("Follow us for awesome patriotic memes. How's the Josh!! #indiavspakistan")
                sleep(3)
